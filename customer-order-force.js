...
(function(){
  ...
  function bind(){
    ...
    if(!b.__chocoOrderBoundV17__){
      b.__chocoOrderBoundV17__=true;
  ...
  function boot(){
    loadTracking();bind();addOrderNav();loadChat();
    [300,1000,2000,3500].forEach(ms=>{setTimeout(loadTracking,ms);setTimeout(bind,ms);setTimeout(addOrderNav,ms);setTimeout(loadChat,ms)});
  }
