...
// This file uses ONLY the existing project's PUBLIC URL + publishable key.
// It intentionally targets ONLY choco_v2_test_* tables.
...
async function v2Request(path, options={}){
  if(!v2Ready()) throw new Error('V2 TEST chưa được cấu hình Supabase.');
