...
(function(){
  ...
  function loadShipperManage(){if(window.__CHOCO_ADMIN_SHIPPER_MANAGE_LOADED__)return;window.__CHOCO_ADMIN_SHIPPER_MANAGE_LOADED__=true;const s=document.createElement('script');s.src='./admin-shipper-manage.js?v=20260909-1';s.async=true;s.onload=()=>console.log('CHOCO ADMIN SHIPPER MANAGE: loaded');s.onerror=e=>console.warn('CHOCO ADMIN SHIPPER MANAGE: load failed',e);document.body.appendChild(s)}
  ...
  const start=()=>{loadShipperMap();loadShipperManage();loadMenuManage()};
